...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://qu.ax/ZfXCR.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '918536881026-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || ' 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄;Skl11;0;https://qu.ax/ZfXCR.jpg;https://whatsapp.com/channel/0029VaWWlqwBVJl0jljvSd2w',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'true',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𓆩‎✘𝙰𝙻𝙴𝚇 𝙿𝙸𝙺𝚄✘𓆪",
    BOT_NAME: process.env.BOT_NAME || '𓆩‎✘𝙰𝙻𝙴𝚇 𝙿𝙸𝙺𝚄✘𓆪',
